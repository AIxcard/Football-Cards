...
| `ACT-166` | `P0` | Startup Freeze Permanent Fix (Non-Blocking Sync), Complete Account Wipe & Free Username Recycling, Full Settings Account Management (Change User & Change Pass), Luxury Daily Reward UI & Skill-Based Telegraphed Tournament (Zero RNG) | `index.html`, `style.css`, `script.js`, `server.js`, `data/db.json` | `web_game_dev` | 🟢 Done |
